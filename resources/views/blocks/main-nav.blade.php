<nav class="main-nav header__nav" id="nav">
    <div class="container">
        <ul class="main-nav__list">
            <li class="main-nav__item main-nav__item--main">
                ...
                <div class="submenu-main">
                    <div class="submenu-main__wrap">
                        <ul class="submenu-main__list">
                            <li class="submenu-main__item submenu-main__item--head">
                                <a class="submenu-main__link submenu-main__link--head" href="/">Трособлочные подъемники</a>
                            </li>
                            <li class="submenu-main__item">
                                <a class="submenu-main__link" href="/">Kаталог</a>
                            </li>
                            <li class="submenu-main__item">
                                <a class="submenu-main__link" href="/">Производство</a>
                            </li>
                            <li class="submenu-main__item">
                                <a class="submenu-main__link" href="/">Объекты</a>
                            </li>
                            <li class="submenu-main__item">
                                <a class="submenu-main__link" href="/">Клиенты</a>
                            </li>
                            <li class="submenu-main__item">
                                <a class="submenu-main__link " href="/">Услуги</a>
                            </li>
                        </ul>
                        <ul class="submenu-main__list">
                            <li class="submenu-main__item submenu-main__item--head">
                                <a class="submenu-main__link submenu-main__link--head" href="/">Краны</a>
                            </li>
                            <li class="submenu-main__item">
                                <a class="submenu-main__link" href="/">Kаталог</a>
                            </li>
                        ...
                        <ul class="submenu-main__list">
                            <li class="submenu-main__item submenu-main__item--head">
                                <a class="submenu-main__link submenu-main__link--head" href="/">Лифты</a>
                            </li>
                            <li class="submenu-main__item">
                                <a class="submenu-main__link" href="/">Kаталог</a>
                            </li>
                        ...
                        <ul class="submenu-main__list">
                            <li class="submenu-main__item submenu-main__item--head">
                                <a class="submenu-main__link submenu-main__link--head" href="/">Гидравлические подъемники</a>
                            </li>
                            <li class="submenu-main__item">
                                <a class="submenu-main__link" href="/">Kаталог</a>
                            </li>
                        ...
                        <ul class="submenu-main__list">
                            <li class="submenu-main__item submenu-main__item--head">
                                <a class="submenu-main__link submenu-main__link--head" href="/">Прочее оборудование</a>
                            </li>
                            <li class="submenu-main__item">
                                <a class="submenu-main__link" href="/">Kаталог</a>
                            </li>
                            ...
                            <li class="submenu-main__item">
                                <a class="submenu-main__link" href="/">Краны</a>
                            </li>
                            <li class="submenu-main__item">
                                <a class="submenu-main__link" href="/">Kаталог</a>
                            </li>
                    ...
                    <div class="submenu-main__wrap">
                        <ul class="submenu-main__list submenu-main__list--bottom">
                            <li class="submenu-main__item">
                                <a class="submenu-main__link submenu-main__link--head" href="/">Наклонные грузовые подъемники</a>
                            </li>
                            <li class="submenu-main__item">
                                <a class="submenu-main__link submenu-main__link--head" href="/">Уникальное грузоподъемное оборудование</a>
                            </li>
                            <li class="submenu-main__item">
                                <a class="submenu-main__link submenu-main__link--head" href="/">Взрывозащищенное оборудование</a>
                            </li>
                        </ul>
                    </div>
                </div>
