            ...
            <div class="checkout__user">
                ...
                <div class="field-radio">
                    ...
                    <div class="field-radio__input-wrap">
                        ...
                        <label class="field-radio__name">
                            <input class="field-radio__input" type="radio" name="tailgate" {{ old('tailgate') == '0' ? 'checked' : ''}} value="0"/>
                ...
                <div class="field-radio">
                    ...
                    <div class="field-radio__input-wrap">
                        ...
                        <label class="field-radio__name">
                            <input class="field-radio__input" type="radio" name="swing_doors" {{ old('swing_doors') == '0' ? 'checked' : ''}} value="0"/>
                            <span class="field-radio__name-text">Нет</span>
                        </label>
                    </div>
                ...
                <div class="field-radio">
                    ...
                    <div class="field-radio__input-wrap">
                        ...
                        <label class="field-radio__name">
                            <input class="field-radio__input" type="radio" name="signaling" {{ old('signaling') == '0' ? 'checked' : ''}} value="0"/>
                            <span class="field-radio__name-text">Нет</span>
                        </label>
                    </div>
                </div>
