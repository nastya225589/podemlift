...
return [
    ...
    */
    'attributes' => [
        ...
        'delivery_at'           => 'Желаемая или максимальная дата поставки/монтажа',
        'delivery'              => 'Доставка и монтаж',
        'carrying'              => 'Грузоподъемность, кг',
        'lift'                  => 'Высота подъема',
        'type_of_lift'          => 'Тип подъемника',
        'place'                 => 'Место установки',
        'number_of_stops'       => 'Количество фиксированных остановок',
        'load_method'           => 'Способ загрузки платформы',
        'type_of_platform'      => 'Тип платформы',
        'tailgate'              => 'Откидные борты на платформе со сторон загрузки/выгрузки',
        'swing_doors'           => 'Распашные двери платформы подъемника со сторон загрузки',
        'signaling'             => 'Системы сигнализации',
        'additionally'          => 'Примечания'
    ],
];
